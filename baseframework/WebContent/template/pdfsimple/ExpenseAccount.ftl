...
<body>  
      ...
      <table cellspacing="0px" cellpadding="0px" class="print"> 
         ...
         <tr>  
            ...
            <td class="left">${expenseAccountAmount}</td>  
            <td class="center">冲账金额</td>  
            <td class="left">${totalWriteOffAmount}</td>  
         ...
         <tr>  
            ...
            <td class="left" style="WORD-WRAP: break-word;width:30px" >${paymentUnitName}</td>  
         ...
         <tr>  
        	...
        	<td class="left"></td>  
             ...
             <#else>
             	<#if expenseKind??>
             		<#if expenseKind == 'setupProject'>
             		 	<td class="center">立项编号</td>  
	             	 	<td class="left">${setupProjectCode}</td>
	             	<#else>
	         ...
	         <#if expenseKind == 'setupProject'>
	          <tr>  
	         	<td class="center">立项名称</td>  
	         	 <td colspan="5" class="left">${setupProjectName}</td>  
	         </tr>
	         <#else>
		         <tr>  
		         	<td class="center">立项名称</td>  
		         	 <td colspan="5" class="left">${setupProjectNameCode}</td>  
		         </tr>
	         </#if>
         </#if>
         <tr>  
