...
<body>  
	...
	<table cellspacing="0" cellpadding="0" class="print">
        ...
        <#if propertyRepairDetail?? && propertyRepairDetail?size gt 0> 
		<#list propertyRepairDetail as propertyRepair>
			<tr >
				<td class="center">${propertyRepair_index?if_exists+1}</td>
				<td class="center">${propertyRepair.materialName?html}</td>
				<td class="center">${propertyRepair.unitTextView?default("")?html}</td>
				<td class="center">${propertyRepair.approvalQuantity}</td>
				<td class="center">${propertyRepair.approvalPrice}</td>
				<td class="center">${propertyRepair.approvalAmount}</td>
				<td class="center">${propertyRepair.deptName}</td>
			</tr> 
		</#list>
		<#else>
			<tr>
