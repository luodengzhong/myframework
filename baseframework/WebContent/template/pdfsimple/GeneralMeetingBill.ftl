  ...
  <div>
    ...
    <div>
     ...
     <table cellspacing="0" cellpadding="0"> 
         <tr>  
         	<td width='50%'>业务类型:${operationName?default("")?html}</td>
            <td width='50%'>模板名称:${biddingTemplateLibraryName?default("&nbsp;")}</td>
         </tr>
         <tr>  
         	<td width='100%' colspan="3">计划名称:${planName?default("&nbsp;")}</td>
         </tr>
         <tr>  
         	<td width='50%'>计划编码:${planCode?default("&nbsp;")}</td>
            <td width='50%'>招标主办人:${responsiblePersonName?default("&nbsp;")}</td>
         </tr>
         <tr>  
         	<td width='50%'>招标方式:${biddingModeTextView?default("&nbsp;")}</td>
            <td width='50%'>过程环节:${stepName?default("&nbsp;")}</td>
         </tr>
         <tr>  
         	<td width='100%' colspan="3">内容:${content?default("&nbsp;")}</td>
         </tr>
         <tr>  
         	<td width='100%' colspan="3">备注:${remark?default("&nbsp;")}</td>
         </tr>
      </table>
