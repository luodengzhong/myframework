...
<body>
	<div class="main">
		<div class="header">
			<div class="logo">
				<a href="http://www.baidu.com/" target="_blank" title="系统框架"></a>
			</div>
		</div>
		<div class="loginCon">
						...
						<div class="login" id="login">
							<form action="" method="post" name="logonForm" id="logonForm">
								<p class="loginText2">
									<em>用户名：</em>
									<label>
										<input type="text" id="userName" name="userName" value=""/><b></b>
									</label>
								</p>
								<p class="loginText2">
									<em>密 &nbsp;码：</em>
		...
		<div class="footer">
			<p class="copyright">
				版权所有 <a href="http://www.lwolf.com.cn/" target="_blank">LuoWolf</a>
			</p>
			<!--  <p class="footLink">
