...
(function ($)
{
    ...
    $.ligerDefaults.Layout = {
        ...
        onSizeChanged: null          //xx add 调整大小结束事件
    };
    ...
    $.ligerui.controls.Layout.ligerExtend($.ligerui.core.UIComponent, {
        ...
        setLeftCollapse: function (isCollapse)
        {
            ...
            if (window['gridManager']) {          
                try{window['gridManager'].reRender();}catch(e){}    //gongmm 2014-02-09 解决左右移动时，grid自适应
            }  
        },
        setRightCollapse: function (isCollapse)
        {
            ...
            g._onResize();
            if (window['gridManager']) {          
                window['gridManager'].reRender();    //gongmm 2014-02-09 解决左右移动时，grid自适应
            }
        },
        _bulid: function ()
        {
...
(function ($)
{
    ...
    $.ligerui.controls.ToolBar.ligerExtend($.ligerui.core.UIComponent, {
        ...
        {        	
            ...
            if (item.line)
            {
            	g.toolBar.append('<div class="l-bar-separator" id="separator_'+ item.id+'"></div>'); //modified by gongmm 2014-02-10
            	return;
            }
			...
			ditem.attr("id", 'toolbar_'+item.id);//added by gongmm 2014-02-10 通过id查找，提高效率
			if (item.title)
            {
