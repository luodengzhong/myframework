...
<head>
    ...
    <script src='<c:url value="/pa/basedata/contractClassification.js"/>' type="text/javascript"></script>
    <title>合同类别管理</title>
</head>
<body>
<div class="mainPanel">
    <div id="mainWrapperDiv">
        <div id="layout">
            <div position="left" title="合同类别树" id="mainmenu">
            ...
            <div position="center" title="合同类别列表">
