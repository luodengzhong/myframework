...
<script src='<c:url value="/pa/basedata/fileTemplate.js"/>'
	type="text/javascript"></script>
<title>文件模板管理</title>
</head>
<body>
	<div class="mainPanel">
		<div id="mainWrapperDiv">
			<div id="layout">
				<div position="left" title="文件模板树" id="mainmenu">
				...
				<div position="center" title="文件模板列表">
					<x:title title="搜索" hideTable="queryTable" />
					<form method="post" action="" id="queryMainForm">
						<div class='ui-form' id='queryTable'>
							<x:inputL name="title" id="title" required="false" label="标题"
								labelWidth="50" />
							&nbsp;&nbsp;
