...
<head>
    ...
    <script src='<c:url value="/pa/projectdata/nodeVariable.js"/>'
            type="text/javascript"></script>
    <title>节点变量管理</title>
</head>
        ...
        <div id="layout">
            ...
            <form method="post" action="" id="queryMainForm">
                <div class='ui-form' id='queryTable'>
                    <x:inputL name="variableCode" id="variableCode" required="false"
                              label="编码" labelWidth="50"/>
                    &nbsp;&nbsp;
                    <x:inputL name="variableName" id="variableName" required="false"
