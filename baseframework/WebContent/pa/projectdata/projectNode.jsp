...
<script src='<c:url value="/pa/projectdata/projectNode.js"/>'
	type="text/javascript"></script>
...
<body>
	<div class="mainPanel">
		<div id="mainWrapperDiv">
			<div id="layout">
				<div position="left" title="项目节点树" id="mainmenu">
				...
				<div position="center" title="项目节点列表">
					<div style="display: block;" id="divTablePanel">
						...
						<form method="post" action="" id="queryMainForm">
							<div class='ui-form' id='queryTable'>
								...
								<x:button value="切换到设计器" id="btnGraphic"/>
								<x:button value="选择模板" id="btnSelectTemplate"/>
							</div>
						</form>
