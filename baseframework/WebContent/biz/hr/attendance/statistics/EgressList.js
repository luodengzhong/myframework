...
function onFolderTreeNodeClick(data) {
	...
	if(!data){
		...
		html.push('<font style="color:Tomato;font-size:13px;">[',fullName,']</font>公出明细');
	}
...
function initializeGrid() {
	...
	gridManager = UICtrl.grid('#maingrid', {
		columns: [
					...
					{ display: "公出人单位", name: "organName", width: 180, minWidth: 180, type: "string", align: "center" },	
				    { display: "公出人中心", name: "centerName", width: 120, minWidth: 120, type: "string", align: "lecenterft" },	
				    ...
				    { display: "公出地点及事由", name: "addressReason", width: 100, minWidth: 60, type: "string", align: "center" },
		...
		dataAction : 'server',
		url: web_app.name+'/attStatisticsAction!slicedQueryEgressList.ajax',
		pageSize : 20,
		width : '100%',
		height : '100%',
		heightDiff : -10,
...
function updateHandler(id){
	if(!id){
		...
		auditId=row.egressId;
	}else{
		auditId=id;
	}

	parent.addTabItem({
		tabid: 'HREgressList'+auditId,
		text: '公出单据查询',
		url: web_app.name + '/attEgressAction!showUpdate.job?bizId=' 
