...
function initializeGrid() {
	...
	gridManager = UICtrl.grid('#maingrid', {
		columns:columns, 
		dataAction : 'server',
		url: web_app.name+'/attStatisticsAction!slicedQueryAttAttendance.ajax',
		parms:{archiviesId:$('#archiviesId').val(),periodId:$('#periodId').val(),startDate:$('#startDate').val(),endDate:$('#endDate').val()},
		pageSize : 10,
		width : '100%',
		height : '100%',
		heightDiff : -5,
