...
<script src='<c:url value="biz/hr/attendance/baseInfo/SumPeriodSpecial.js"/>' type="text/javascript"></script>
</head>
  <body>
  	<div class="mainPanel">
				...
				<div position="center" title="期间特殊情况设置">
					...
					<form method="post" action="" id="queryMainForm">
						...
						<div class="ui-form" id="queryDiv" style="width: 900px;">
							...
							<x:inputL name="periodName" label="业务期间"  required="true" wrapper="combo" width="220" labelWidth="70" />
							<dl>
