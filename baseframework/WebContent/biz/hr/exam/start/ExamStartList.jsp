...
<script src='<c:url value="/biz/hr/exam/start/ExamStartList.js"/>' type="text/javascript"></script>
</head>
<body>
	<div class="mainPanel">
		<div id="mainWrapperDiv">
			<div id="layout">
				...
				<div position="center" title="考试计划列表">
					...
					<form method="post" action="" id="queryMainForm">
						<div class="ui-form" id="queryDiv" style="width: 900px;">
							...
							<x:selectL name="status" label="状态" list="statusList"/>	
							<x:hidden name="examinationTypeId" />
							<x:inputL name="examinationTypeName"  label="考试类型"	wrapper="select"/>
							<x:inputL name="managerName" required="false" label="阅卷人" maxLength="64" />
							<dl>
