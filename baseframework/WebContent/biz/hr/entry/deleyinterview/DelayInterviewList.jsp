...
<html>
  <head>
  	...
  	<script src='<c:url value="/biz/hr/entry/deleyinterview/DelayInterview.js"/>' type="text/javascript"></script>
  	...
  	<div class="mainPanel">
		<div id="mainWrapperDiv">
			<div id="layout">
				...
				<div position="center" title="延期转正面谈记录列表">
					<x:title title="延期转正面谈记录列表" hideTable="queryDiv" />
			<form method="post" action="" id="queryMainForm">
			<div class="ui-form" id="queryDiv" style="width:900px;">
					
		<x:hidden name="delayInterviewId"/>
		<x:inputL name="staffName" required="false" label="员工姓名" maxLength="32"/>					
		<x:inputL name="speakPersonMemberName" required="false" label="面谈人姓名" maxLength="32"/>					
