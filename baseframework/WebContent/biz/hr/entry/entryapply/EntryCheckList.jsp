...
<html>
  <head>
  	...
  	<script src='<c:url value="/biz/hr/entry/entryapply/EntryCheckList.js"/>'   type="text/javascript"></script>
  ...
  <body>
  	<div class="mainPanel">
	  	...
	  	<!-- 	<div id="layout">
				...
				<div position="center" title="入职手续办理列表"> -->
	  		<x:title title="入职手续办理列表" hideTable="queryDiv"/>
	  				<x:hidden name="id"  />
