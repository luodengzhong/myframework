...
<html>
  <head>
  	<x:base include="dialog,grid,dateTime,combox"/>
  	  	  	<script src='<c:url value="/biz/hr/entry/teacher/TeacherPlanTaskBill.js"/>'   type="text/javascript"></script>
  </head>
  <body>
  	<div class="ui-form" style="width: 99%;">
		...
		<x:textareaTD name="contentOne" required="true" label="试用期第一个月" rows="7"  colspan="4" maxLength="512"/>	
		</tr>
		 <tr>
		<x:textareaTD name="contentTwo" required="true" label="试用期第二个月" rows="7"  colspan="4" maxLength="512"/>	
		</tr>	
		 <tr>
		<x:textareaTD name="contentThree" required="true" label="试用期第三个月" rows="7"  colspan="4" maxLength="512"/>
		</tr>	
