...
<script src='<c:url value="/biz/hr/entry/teacher/TeacherPlanList.js"/>' type="text/javascript"></script>
	...
	<div class="mainPanel">
		<div id="mainWrapperDiv">
			<div id="layout">
				...
				<div position="center" title="督导师计划表列表">
					<x:title title="督导师计划表列表" hideTable="queryDiv" />
