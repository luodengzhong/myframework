...
<script src='<c:url value="/biz/hr/pay/specialreward/SpecialRewardStagesList.js"/>' type="text/javascript"></script>
</head>
<body>
	<div class="mainPanel">
		<div id="mainWrapperDiv">
			<div id="layout">
				...
				<div position="center" title="奖罚分配分期明细">
					...
					<form method="post" action="" id="queryMainForm">
						<div class="ui-form" id="queryDiv" style="width: 900px;">
							...
							<x:selectL name="isGroupAmount" label="团队" dictionary="yesorno"  labelWidth="50" width="60"/>
							<x:selectL name="isByStages" label="分期" dictionary="yesorno" labelWidth="50" width="60"/>
							<x:selectL name="isEffect" label="执行" dictionary="yesorno"  labelWidth="50" width="60"/>
							<div class="clear"></div>
