...
<script src='<c:url value="/biz/hr/pay/specialreward/SpecialRewardByStages.js"/>' type="text/javascript"></script>
</head>
<body>
	<div class="mainPanel">
		<div id="mainWrapperDiv">
			<div class="subject">奖罚分期确认</div>
			<form method="post" action="" id="submitForm">
				<table class='tableInput' style="width: 99%;">
					<x:layout />
					<x:hidden name="auditId" />
					<x:hidden name="organId" />
					<x:hidden name="isFirstAudit" />
					<x:hidden name="firstAuditId" />
					<x:hidden name="defStartPeriodId" />
					<x:hidden name="defStartPeriodName" />
					<tr>
					...
					<tr>
						...
						<x:inputTD name="allAmount" readonly="true" label="总金额" mask="money" />
					</tr>
					<tr>
