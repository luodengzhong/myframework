...
<html>
  <head>
  	...
  	<script src='<c:url value="/biz/hr/pay/specialreward/SpecialRewardApply.js"/>' type="text/javascript"></script>
  </head>
  <body>
  	<div class="mainPanel">
	  	<div id="mainWrapperDiv">
			...
			<div class="ui-form" id="queryDiv" style="width:900px;">
				...
				<x:selectL name="rewardApplyKind" label="类别" id="mainRewardApplyKind"/>
				<x:selectL name="status"  list="specialRewardStatus" label="状态" id="specialRewardStatus"/>
					<dl>
