...
<script src='<c:url value="/biz/hr/pay/freeze/PayFreezeDetailList.js"/>' type="text/javascript"></script>
</head>
<body>
	<div class="mainPanel">
		<div id="mainWrapperDiv">
			<div id="layout">
				...
				<div position="center" title="修改明细">
					...
					<form method="post" action="" id="queryMainForm">
						<div class="ui-form" id="queryDiv" style="width: 900px;">
							...
							<x:selectL name="wageFlag" label="工资发放标志"/>	
