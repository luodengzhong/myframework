...
<script src='<c:url value="/biz/hr/pay/deduct/CommonWageDataDetail.js"/>' type="text/javascript"></script>
</head>
<body>
<div class="mainPanel">
	<div class="subject">通用工资数据审批表</div>
	<form method="post" action="" id="submitForm">
		<table class='tableInput' style="width: 99%;">
			...
			<tr>
				<x:selectTD name="commonWageKind" id="commonWageKind" emptyOption="true" required="true" label="类型" />
				<td class="title" colspan="4"></td>
			</tr>
		</table>
	</form>
	<div class="blank_div"></div>
	<x:fileList bizCode="CommonWageData" bizId="auditId" id="commonWageDataFileList"/>
	<div class="blank_div"></div>
	<div id="maingrid"></div>
</div>
</body>
