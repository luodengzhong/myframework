...
<script src='<c:url value="/biz/hr/pay/deduct/CommonWageDataDetailList.js"/>' type="text/javascript"></script>
</head>
<body>
	<div class="mainPanel">
		<div id="mainWrapperDiv">
			<div id="layout">
				...
				<div position="center" title="通用工资数据明细">
					...
					<form method="post" action="" id="queryMainForm">
						<div class="ui-form" id="queryDiv" style="width: 900px;">
							...
							<x:selectL name="commonWageKind" label="类别" id="commonWageKind"/>	
