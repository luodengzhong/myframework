...
<script src='<c:url value="/biz/hr/pay/deduct/CompensationDeductDetailList.js"/>' type="text/javascript"></script>
</head>
<body>
	<div class="mainPanel">
		<div id="mainWrapperDiv">
			<div id="layout">
				...
				<div position="center" title="补发补扣明细">
					...
					<form method="post" action="" id="queryMainForm">
						<div class="ui-form" id="queryDiv" style="width: 900px;">
							...
							<x:selectL name="compensateKind" label="类别" id="mainCompensateKind"/>	
							...
							<x:inputL name="year" required="false" label="业务年"  spinner="true"/>
