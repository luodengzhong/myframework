...
<script src='<c:url value="/biz/hr/pay/rewardPunish/RewardPunishDetailList.js"/>' type="text/javascript"></script>
</head>
<body>
	<div class="mainPanel">
		<div id="mainWrapperDiv">
			<div id="layout">
				...
				<div position="center" title="奖罚明细">
					...
					<form method="post" action="" id="queryMainForm">
						<div class="ui-form" id="queryDiv" style="width: 900px;">
							...
							<x:selectL name="rewardorpunish" label="类别"/>	
							<x:selectL name="awardPenalKind" label="奖罚分类"/>	
							...
							<dl>
								<dd style="width:150px;padding-left: 5px;">
									<x:checkbox name="notShowCancel" label="不显示作废数据" />&nbsp;
								</dd>
							</dl>
							<div class="clear"></div>
