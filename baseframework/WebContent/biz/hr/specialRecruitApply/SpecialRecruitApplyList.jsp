...
<html>
  <head>
  	...
  	<script src='<c:url value="/biz/hr/specialRecruitApply/SpecialRecruitApplyList.js"/>' type="text/javascript"></script>  
  ...
  <body>
  	<div class="mainPanel">
	  	<div id="mainWrapperDiv">
				...
				<div position="center" title="专项招聘任务下达申请列表">
	  		<x:title title="专项招聘任务下达申请列表" hideTable="queryDiv"/>
