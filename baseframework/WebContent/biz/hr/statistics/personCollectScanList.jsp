...
<script src='<c:url value="/biz/hr/statistics/personCollectScanList.js"/>' type="text/javascript"></script>
</head>
<body>
	<div class="mainPanel">
				...
				<div position="center" title="人员列表">
					...
					<form method="post" action="" id="queryMainForm">
						<div class="ui-form" id="queryDiv" style="width: 900px;">
							...
							<x:selectL name="staffingLevel" label="编制类别" maxLength="16" />
							<x:inputL name="state" label="状态" labelWidth="80" />
							<x:inputL name="workExperienceDetail" label="搜索条件" labelWidth="80" />
