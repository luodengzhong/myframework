...
<script src='<c:url value="/biz/hr/change/reshuffle/OffsiteAllowanceList.js"/>' type="text/javascript"></script>
</head>
<body>
	<div class="mainPanel">
		<div id="mainWrapperDiv">
			<div id="layout">
				...
				<div position="center" title="异动津贴">
					...
					<form method="post" action="" id="submitForm">
						...
						<div class="ui-form" id="queryDiv" style="width: 900px;">
							...
							<x:select name="reshuffleType" id="mainReshuffleType" cssStyle="display:none;" emptyOption="false" />
							<dl>
