...
<head>
        ...
        <script src='<c:url value="/lib/jquery/jquery.formButton.js"/>' type="text/javascript"></script>
  	  	<script src='<c:url value="/biz/hr/change/reshuffle/SecondmentOffsiteAllowance.js"/>'   type="text/javascript"></script>
  </head>

  <body>
  	<div class="ui-form" style="width: 99%;">
  			<div class="subject">借调津贴审批表</div>
	...
	<table>
		...
		<tr>
		      <x:inputTD name="toOrganName" required="false" label="单位"  wrapper="select "/>	
		      <x:inputTD name="toCenterName" required="false" label="中心"  wrapper="select "/>			
		      <x:inputTD name="toDeptName" required="false" label="部门"  wrapper="select "/>	
		</tr>
		</table>
		...
		<tr>		
		      <x:textareaTD name="systemBasis" required="true" label="享受津贴依据说明" colspan="5" rows="3" maxLength="256" />	
		</tr>
		</table>
			</form>
