...
<script src='<c:url value="/biz/hr/change/reshuffle/ReshuffleList.js"/>' type="text/javascript"></script>
</head>
<body>
	<div class="mainPanel">
				...
				<div position="center" title="异动明细">
					...
					<form method="post" action="" id="submitForm">
						...
						<div class="ui-form" id="queryDiv" style="width: 900px;">
							...
							<x:inputL name="effectiveBeginDate" required="false" label="生效日期起" wrapper="date" />
							<x:inputL name="effectiveEndDate" required="false" label="生效日期止" wrapper="date" />
							<x:selectL name="reshuffleType" id="mainReshuffleType"  label="异动类型"/>
							<dl>
