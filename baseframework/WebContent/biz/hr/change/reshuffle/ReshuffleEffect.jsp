...
<head>
        ...
        <script src='<c:url value="/lib/jquery/jquery.formButton.js"/>' type="text/javascript"></script>
  	  	<script src='<c:url value="/biz/hr/change/reshuffle/ReshuffleEffect.js"/>'   type="text/javascript"></script>
  </head>
  ...
  <body>
	 ...
	 <table>		        
		...
		<tr>
		    ...
		    <x:selectTD name="isEffect" required="true" label="是否同步档案信息"  dictionary="yesorno"/>	
