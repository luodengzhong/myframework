...
function reshuffleEffectAdvance(){
	$('#submitForm').ajaxSubmit({
		url : web_app.name + '/reshuffleAction!reshuffleEffectAdvance.ajax',
		success : function() {
...
function reshuffleEffectStop(){
	var taskId=$('#taskId').val();
	var auditId=$('#auditId').val();
	Public.ajax(web_app.name + "/reshuffleAction!reshuffleEffectStop.ajax",
