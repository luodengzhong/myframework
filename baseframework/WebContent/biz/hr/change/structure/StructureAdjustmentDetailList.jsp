...
<script src='<c:url value="/biz/hr/change/structure/StructureAdjustmentDetailList.js"/>' type="text/javascript"></script>
</head>
<body>
	<div class="mainPanel">
				...
				<div position="center" title="异动明细">
					...
					<form method="post" action="" id="queryMainForm">
						<div class="ui-form" id="queryDiv" style="width: 900px;">
							...
							<x:inputL name="staffName" required="false" label="员工" maxLength="64" />
