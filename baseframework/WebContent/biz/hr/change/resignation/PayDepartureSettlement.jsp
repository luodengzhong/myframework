...
<body>
	<div class="ui-form" style="width: 99%;">
		...
		<div class="bill_info" style='text-align: right;'>
			<span > 单据号码：<strong><c:out value="${billCode}" /></strong> &nbsp;&nbsp; 制表日期：<strong><x:format
						type="date" name="fillinDate" /> </strong>
			</span> <span> 制表人：<strong><c:out value="${personMemberName}" /></strong>
			</span>
		</div>
	</div>
		<div class="ui-form">
			<form method="post" action="" id="submitForm">
				...
				<table class='tableInput' style="width: 99%; margin-left: 4px;">
					...
					<tr>
						...
						<x:selectTD name="wageAffiliation" required="true" label="工资费用归属"/>
					</tr>
					<tr>
						<x:inputTD name="phoneNumber" required="false" label="通讯号码" maxLength="64" disabled="true" />
						<x:inputTD name="idCardNo" required="false" label="身份证" maxLength="64" disabled="true" />
		...
		<div id='detailTabs' style="width: 99%;">
			<div class="ui-tab-links">
				<h2>结算单详细</h2>
				<ul>
					<c:forEach items="${requestScope.settlements}" var="settlement">
						<li>
						<c:if test="${settlement.attendanceDate!=''}">
						考勤截止&nbsp;
						<a href="##" class="GridStyle" title="点击查看考勤统计结果" onclick="showAttInfo(<c:out value="${settlement.attStatId}" />)">
							<fmt:formatDate value="${settlement.attendanceDate}" type="date" />
						</a>
						</c:if>
						<c:if test="${settlement.attendanceDate==''}">
						结算单
					...
					<div class="layout">
						<form method="post" action="" class="settlementForm" id="settlementForm_<c:out value="${settlement.settlementId}" />">
							...
							<table class='tableInput' style="width: 99%;">
								<x:layout proportion="12%,21%,12%,21%,10%" />
								<tr>
									<td class="title"><span class="labelSpan">月工资标准&nbsp;:</span></td>
									<td class="edit"><input type="text" name="standardPay" value="<c:out value="${settlement.standardPay}"/>" class="text"
										mask="money" /></td>
									<td class="title"><span class="labelSpan">基本工资&nbsp;:</span></td>
									<td class="edit"><input type="text" name="basePay" value="<c:out value="${settlement.basePay}"/>" class="text" mask="money" /></td>
									<td class="title"><span class="labelSpan">绩效工资&nbsp;:</span></td>
									<td class="edit"><input type="text" name="performancePay" value="<c:out value="${settlement.performancePay}"/>" class="text"
										mask="money" /></td>
								</tr>
								<tr>
									<td class="title"><span class="labelSpan">工龄工资&nbsp;:</span></td>
									<td class="edit"><input type="text" name="seniorityPay" value="<c:out value="${settlement.seniorityPay}"/>" class="text"
										mask="money" /></td>
									<td class="title"><span class="labelSpan">加班补贴&nbsp;:</span></td>
									<td class="disable"><input type="text" name="overtime" value="<c:out value="${settlement.overtime}"/>" readonly="true" class="text textReadonly"  mask="money" />
									</td>
								...
								<tr>
									...
									<td class="edit"><input type="text" name="mealAllowance" value="<c:out value="${settlement.mealAllowance}"/>" class="text"
										mask="money" /></td>
									<td class="title"><span class="labelSpan">异地津贴&nbsp;:</span></td>
									<td class="edit"><input type="text" name="distanceAllowance" value="<c:out value="${settlement.distanceAllowance}"/>"
										class="text" mask="money" /></td>
									<td class="title"><span class="labelSpan">岗位津贴&nbsp;:</span></td>
									<td class="edit"><input type="text" name="pay10" value="<c:out value="${settlement.pay10}"/>" class="text" mask="money" /></td>
								</tr>
								<tr>
							...
							<table class='tableInput' style="width: 99%;">
								...
								<tr>
									<td class="title"><span class="labelSpan">考勤截止日期&nbsp;:</span></td>
									<td class="disable"><input type="text" name="attendanceDate" date="true"  readonly="true" class="text textReadonly"  value="<c:out value="${settlement.attendanceDate}"/>"/></td>
									<td class="title"><span class="labelSpan">计薪天数&nbsp;:</span></td>
									<td class="disable"><input type="text" name="allDays" value="<c:out value="${settlement.allDays}"/>" readonly="true" class="text textReadonly" /></td>
									<td class="title"><span class="labelSpan">未出勤天数&nbsp;:</span></td>
									<td class="disable"><input type="text" name="vacancyDays" value="<c:out value="${settlement.vacancyDays}"/>" readonly="true" class="text textReadonly" /></td>
								</tr>
								<tr>
									<td class="title"><span class="labelSpan">病假天数&nbsp;:</span></td>
									<td class="disable"><input type="text" name="sickDays" value="<c:out value="${settlement.sickDays}"/>" readonly="true" class="text textReadonly" /></td>
									<td class="title"><span class="labelSpan">事假天数&nbsp;:</span></td>
									<td class="disable"><input type="text" name="affairsDays" value="<c:out value="${settlement.affairsDays}"/>" readonly="true" class="text textReadonly" /></td>
									<td class="title"><span class="labelSpan">病假扣款&nbsp;:</span></td>
									<td class="disable"><input type="text" name="pay06" value="<c:out value="${settlement.pay06}"/>" readonly="true" class="text textReadonly" /></td>
								</tr>
								<tr>
									<td class="title"><span class="labelSpan">事假扣款&nbsp;:</span></td>
									<td class="disable"><input type="text" name="pay07" value="<c:out value="${settlement.pay07}"/>" readonly="true" class="text textReadonly" /></td>
								    <td class="title"><span class="labelSpan">迟到早退扣款&nbsp;:</span></td>
									<td class="disable"><input type="text" name="pay08" value="<c:out value="${settlement.pay08}"/>" readonly="true" class="text textReadonly"  /></td>
									<td class="title"><span class="labelSpan">缺勤扣款&nbsp;:</span></td>
									<td class="disable"><input type="text" name="pay09" value="<c:out value="${settlement.pay09}"/>" readonly="true" class="text textReadonly" /></td>
								</tr>
								<tr>
									<td class="title"><span class="labelSpan">社保缴费截止&nbsp;:</span></td>
									<td class="edit"><input type="text" name="socialSecurityDate" value="<c:out value="${settlement.socialSecurityDate}"/>"
										class="text" date="true" /></td>
									<td class="title"><span class="labelSpan">公积金缴费截止&nbsp;:</span></td>
									<td class="edit"><input type="text" name="accumulationDate" value="<c:out value="${settlement.accumulationDate}"/>"
										class="text" date="true" /></td>
							...
							<table class='tableInput' style="width: 99%;">
								...
								<tr>
									...
									<td class="edit" colspan="1">
										<input type="text" name="relevanceTaxablePay" value="<c:out value="${settlement.relevanceTaxablePay}"/>" class="text" mask="money" />
									</td>
									<td class="title"><span class="labelSpan">关联单据所得税&nbsp;:</span></td>
									<td class="edit" colspan="1">
										<input type="text" name="relevanceIncomeTax" value="<c:out value="${settlement.relevanceIncomeTax}"/>" class="text" mask="money" />
									</td>
