...
<html>
  <head>
  	...
  	<script src='<c:url value="/biz/hr/recruit/personnelquota/AffirmPersonList.js"/>' type="text/javascript"></script>  
  ...
  <body>
  	<div class="mainPanel">
	  	<div id="mainWrapperDiv">
				...
				<div position="center" title="编制定员申请单列表">
	  		<x:title title="编制定员申请单列表" hideTable="queryDiv"/>
