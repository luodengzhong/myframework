...
<table class='tableInput' style="width: 99%;">
		...
		<x:inputTD name="organName" required="true" label="招聘单位"   />	
		<x:hidden name="deptId"/>
			<x:inputTD name="deptName" required="true" label="招聘部门"  />	
			</tr>
			<tr>
			<x:hidden name="recPosId"/>
			<x:inputTD name="name" required="true" label="招聘岗位" />	
		...
		<tr>	
		<x:radioTD name="isSocialRecruit" required="false" label="是否官网招聘" dictionary="yesorno"  colspan="3" />	
		</tr>
		<tr>	
