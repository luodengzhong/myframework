...
<script
	src='<c:url value="/biz/hr/performanceassess/assessmentaudit/AssessmentPersonAuditBill.js"/>'
	type="text/javascript"></script>

</head>
<body>
	<div class="mainPanel">
		<div class="subject">评分名单审批</div>
		<form method="post" action="" id="submitForm">
			<div class="bill_info">
				<span style="float: left;"> 单据号码：<strong><c:out
							value="${billCode}" /></strong> &nbsp;&nbsp; 申请日期：<strong> <x:format
							name="fillinDate" type="date" /></strong>
				</span> <span style="float: left;"> &nbsp;&nbsp;申请人：<strong><c:out
