...
<x:base include="dialog,grid,dateTime,combox,tree,attachment" />
    <script src='<c:url value="/biz/hr/performanceassess/updateAssessTask/PerformanceAssessProgressDetail.js"/>' type="text/javascript"></script>
...
<body>
	<div class="ui-form" style="width: 99%;">
		<div class="subject">发送更新绩效考核表任务</div>
