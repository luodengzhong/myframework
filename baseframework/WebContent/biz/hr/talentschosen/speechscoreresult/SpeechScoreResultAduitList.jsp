...
<script src='<c:url value="/biz/hr/talentschosen/speechscoreresult/SpeechScoreResultAduitList.js"/>' type="text/javascript"></script>
</head>
<body>
	<div class="mainPanel">
		<div id="mainWrapperDiv">
			<div id="layout">
				...
				<div position="center" title="竞聘结果审批列表">
					<x:hidden name="parentId" id="treeParentId" />
					<x:title title="竞聘结果审批列表" hideTable="queryDiv" />
