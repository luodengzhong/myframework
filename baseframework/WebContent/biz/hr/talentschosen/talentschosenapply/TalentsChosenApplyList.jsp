...
<script src='<c:url value="/biz/hr/talentschosen/talentschosenapply/TalentsChosenApplyList.js"/>' type="text/javascript"></script>
</head>
<body>
	<div class="mainPanel">
			...
			<div id="layout">
				...
				<div position="center" title="员工列表">
					...
					<form method="post" action="" id="queryMainForm">
							...
							<x:selectL name="education" required="false" label="学历"
								maxLength="2" />
							<x:inputL name="chosenPosName" required="false" label="选拨岗位"
								maxLength="64" />
							<x:selectL name="competeStatus" required="false" label="状态"
								list="competeResultStatus" />
							<dl>
