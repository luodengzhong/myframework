...
<script src='<c:url value="/biz/oa/setup/UserGroup.js"/>' type="text/javascript"></script>
</head>
<body>
	<div class="mainPanel">
				...
				<div position="center" title="分组列表">
					...
					<form method="post" action="" id="queryMainForm">
						<div class="ui-form" id="queryDiv">
							<x:inputL name="code" label="编码" labelWidth="60" />
							<x:inputL name="name" label="名称" labelWidth="60" />
							<dl>
