...
<script src='<c:url value="/biz/oa/askReport/agencyCoopera/AgencyCooperaMeeting.js"/>' type="text/javascript"></script>
</head>
<body>
	<div class="mainPanel">
...
<!-- 			<div class="blank_div"></div> -->
<%-- 			<x:fileList bizCode="agencyCoopera" --%>
<%-- 				bizId="agencyCooperaId" id="agencyCooperaIdAttachment" /> --%>
			<div class="blank_div"></div>
			<div class="layout" id="agency_coopera_detail_tab" >
				<div id=agency_coopera_detail></div>
			</div>
		</form>
