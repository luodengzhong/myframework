...
<script src='<c:url value="/biz/oa/askReport/institutionAmendment/InstitutionAmendment.js"/>' type="text/javascript"></script>
</head>
<body>
	<div class="mainPanel">
		...
		<form method="post" action="" id="submitForm">
			<table class='tableInput' style="width: 99.9%;">
				...
				<tr>
					...
					<x:selectTD name="flevel" required="true" label="制度文件级别" maxLength="64" dictionary="institutionLevel"/>		
					<td colspan="2"></td> 
				</tr>
			</table>
			...
			<div class="blank_div"></div>
			<x:fileList bizCode="institutionAmendment"
				bizId="institutionId" id="institutionIdAttachment" />
			<div class="blank_div"></div>
			<div class="layout" id="institution_tab" >
				<div id="maingrid"></div>
			</div>
		</form>
