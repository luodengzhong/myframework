...
<script src='<c:url value="/PartnerLogin.js"/>' type="text/javascript"></script>
...
<script src='<c:url value="/biz/sp/partner/baseinfo/PartnerContactRegister.js"/>' type="text/javascript"></script>
</head>
<body>
	<div class="main">
		<div class="header">
						...
						<div class="login" id="login">
							<form action="" method="post" name="logonForm" id="logonForm">
								...
								<p class="loginState">
									...
									<span><a href="javascript:void(null);" id="registeredUser" hidefocus>立即注册</a></span>
								</p>
								<p class="submitBut">
