...
function onFolderTreeNodeClick(data) {
	...
	if(!data){
		...
		html.push('<font style="color:Tomato;font-size:13px;">[',fullName,']</font>错误日志');
	}
...
function initializeGrid() {
	gridManager = UICtrl.grid('#maingrid', {
		columns: [
		    ...
		    { display: "类名", name: "className", width: 160, minWidth: 60, type: "string", align: "left" },
		    { display: "方法名", name: "functionName", width: 100, minWidth: 60, type: "string", align: "left" },
		    { display: "异常信息", name: "exception", width: 300, minWidth: 60, type: "string", align: "left" }
