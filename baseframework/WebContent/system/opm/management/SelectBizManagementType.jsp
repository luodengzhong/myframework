...
<script
	src='<c:url value="/system/opm/management/SelectBizManagementType.js"/>'
...
<div class="mainPanel">
	<div id="mainWrapperDiv">
		<div id="layout">
			<div position="left" title="业务管理权限类别" id="mainmenu">
			...
			<div position="center" title="业务管理权限类别列表">
				...
				<form method="post" action="" id="queryMainForm">
					<div class='ui-form' id='queryTable'>
						<x:inputL name="code" required="false" label="编码" readonly="false"
							labelWidth="50" />
