...
OpmUtil.showSelectOrgTypeDialog = function (options) {
    UICtrl.showFrameDialog({
        url: web_app.name + '/orgTypeAction!showSelectOrgTypeDialog.do',
        param: {
...
OpmUtil.showSelectOrgTemplateDialog = function (options) {
    UICtrl.showFrameDialog({
        url: web_app.name
				+ '/orgTemplateAction!showSelectOrgTemplateDialog.do',
        title: "选择机构模板",
        lock: options.lock,
        width: 760,
        height: 400,
...
OpmUtil.showSelectBizManagementTypeDialog = function (options) {
    UICtrl.showFrameDialog({
        url: web_app.name
				+ '/managementAction!showSelectBizManagementTypeDialog.do',
        title: "选择业务管理权限",
        param: { multiSelect: options.multiSelect == "true" ? "true" : "false" },
        width: 600,
        height: 400,
        ok: options.confirmHandler,
        close: options.closeHandler
...
OpmUtil.showOrgFunctionDialog = function (options) {
    UICtrl.showFrameDialog({
        url: web_app.name
				+ '/orgAction!showSelectOrgFunctionDialog.do',
        title: "选择组织职能",
        width: 600,
        height: 400,
        cancelVal: '关闭',
...
OpmUtil.OrgImagePath = web_app.name + "/themes/default/images/org/";
...
OpmUtil.getSelectOrgDefaultParams = function () {
    return {
        ...
        showDisabledOrg: false,
        showVirtualOrg: false,
        showProjectOrg: false,
        showPosition: false,
        chooseChildCheck:true,
        listMode: false,
