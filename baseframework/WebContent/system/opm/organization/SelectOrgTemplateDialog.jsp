...
<script
	src='<c:url value="/system/opm/organization/SelectOrgTemplateDialog.js"/>'
	type="text/javascript"></script>
...
<body>
	<div class="mainPanel">
		<div id="mainWrapperDiv">
			<div id="layout">
				<div position="left" title="组织模板树" id="mainmenu">
					...
					<form method="post" action="" id="queryMainForm">
						<div class='ui-form' id='queryTable'>
							<x:inputL name="code" required="false" label="编码"
								readonly="false" labelWidth="50" width="100" />
							<x:inputL name="name" required="false" label="名称" labelWidth="50" width="140"  />
							&nbsp;&nbsp;
