...
$(function () {
    ...
    function initializeOperateCfg() {
        var path = web_app.name + '/funAction!';
        ...
        operateCfg.deleteBizFunctionAction = 'funAction!deleteBizFunction.ajax';
        ...
        operateCfg.deleteBizFunctionOwnBaseAction = 'funAction!deleteBizFunctionOwnBase.ajax';
    }
    ...
    function initializateSelectBaseFunctionType() {
        $('#maingrid #toolbar_menuAdd').comboDialog({ type: 'opm', name: 'selectBaseFunctonType', width: 480,
            ...
            onChoose: function () {
                ...
                var url = web_app.name + "/funAction!saveBizFunctionOwnBase.ajax";
...
function saveBizFunction() {
    ...
    Public.ajax(operateCfg.saveBizFunctionAction,
        { data: encodeURI($.toJSON(bizFunctiondata)) }, function () {
            bizFunctionGridManager.loadData();
        }
    );
}
