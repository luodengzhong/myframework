...
<html>
<head>
<x:base include="layout,dialog,grid,combox,dateTime,tree" />
<script
	src='<c:url value="/system/opm/permission/SelectRoleDialog.js"/>'
			...
			<div position="center" title="列表">
				...
				<form method="post" action="" id="queryMainForm">
					<div class='ui-form' id='queryTable'>
						<x:inputL name="code" required="false" label="编码" readonly="false" width="100" labelWidth="50"/>
						<x:inputL name="name" required="false" label="名称"  width="100" labelWidth="50"/>
						&nbsp;&nbsp;
