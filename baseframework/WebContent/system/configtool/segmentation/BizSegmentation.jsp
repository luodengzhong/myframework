...
<script src='<c:url value="/lib/jquery/jquery.comboDialog.js"/>'
	type="text/javascript"></script>
<script
	src='<c:url value="/system/configtool/segmentation/BizSegmentation.js"/>'
	type="text/javascript"></script>
	...
	<div class="mainPanel">
		<div id="mainWrapperDiv">
			<div id="layout">
				...
				<div position="center" title="业务段管理" id="bizSegmentationtList">
				    <x:select name="segmentationKind" list="segmentationKindList"
								cssStyle="display:none;" emptyOption="false" />
					<div id="bizSegmentationGrid" style="margin: 2px;"></div>
