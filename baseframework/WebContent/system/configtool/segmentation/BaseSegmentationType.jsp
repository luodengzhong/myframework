...
<script src='<c:url value="/system/configtool/segmentation/BaseSegmentationType.js"/>' type="text/javascript"></script>
</head>
<div class="mainPanel">
	<div id="mainWrapperDiv">
		<div id="layout">
			<div position="left" title="基础段类别" id="mainmenu">
				<div style="overflow-x: hidden; overflow-y: auto; width: 100%;" id="divTreeArea">
					<ul id="maintree"></ul>
				</div>
			</div>
			<div position="center" title="基础段类别列表">
