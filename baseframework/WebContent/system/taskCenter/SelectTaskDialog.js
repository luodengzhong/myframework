...
$(function () {
    ...
    */
    function initGrid() {
        gridManager = UICtrl.grid("#maingrid", {
            columns: [
            		   { display: "操作", name: "operate", width: 50, minWidth: 30, type: "string", align: "left",frozen: true,
            		     	render: function (item) { 
								return '<a href="##" class="GridStyle addHandler"><span class="ui-icon ui-icon-plus">&nbsp;</span>添加</a>';
							}
            		   },
    ...
    * 初始化选择任务列表
    */
    function initSelectedGrid() {
        selectedGridManager = UICtrl.grid("#selectedgrid", {
            columns: [
            			{ display: "操作", name: "operate", width: 50, minWidth: 30, type: "string", align: "left",frozen: true,
            		     	render: function (item) { 
								return '<a href="##" class="GridStyle deleteHandler"><span class="ui-icon ui-icon-trash">&nbsp;</span>删除</a>';
							}
            		   },
            			{ display: "编码", name: "bizCode", width: 120, minWidth: 60, type: "string", align: "left" },
            			{ display: "主题", name: "description", width: 300, minWidth: 60, type: "string", align: "left" },
