...
<script src='<c:url value="/system/extendedfield/extendedFieldGroup.js"/>' type="text/javascript"></script>
</head>
<body>
	<div class="mainPanel">
				...
				<div position="center" title="扩展属性分组">
					...
					<form method="post" action="" id="queryMainForm">
						<div class="ui-form" id="queryTable">
							<x:inputL name="code" label="分组编码" maxLength="30" />
							<x:inputL name="name" label="分组名称" maxLength="64" />
							<div class="clear"></div>
							<x:inputL name="businessCode" label="业务编码" maxLength="30" />
							&nbsp;&nbsp;
